...
function spocitej() {
    ...
    function(data) {
        ...
        let datum_zavodu = JSON.parse(data)["Data"]["Date"];
        ...
        function(data) {
            ...
            $.get( "https://oris.orientacnisporty.cz/API/?format=json&method=getUserEventEntries&datefrom=" + datum_zavodu + "&userid=" + id_zavodnika,
            function(data) {
                let vsechny_zavody = JSON.parse(data)["Data"];
                console.log(vsechny_zavody);
                vsechny_zavody = Object.keys(vsechny_zavody).map(function(key) {return vsechny_zavody[key];});
                console.log(vsechny_zavody);
                vsechny_zavody.reverse();

                for (let zavod of vsechny_zavody) {
